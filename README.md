...
dotnet build src/FCG.Games.
Api/FCG.Games.Api.csproj
...
📹 Demonstração
O vídeo de apresentação está disponível em: https://youtu.be/ZtlMZ71-1Qw


📝 Licença
Este projeto é acadêmico, desenvolvido para fins educacionais no curso de Arquitetura .NET com Azure (FIAP).
